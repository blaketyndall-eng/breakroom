...
// ============================================================================
// RETRO-GOOGLE HOMEPAGE CORPUS SEARCH
// ============================================================================
// Merged from origin/main: shared helpers used by both the React SearchBox
// island (live preview count on the homepage) and the server-rendered SERP
// page at /sleepnet/search?q=... so the two stay in lockstep.
