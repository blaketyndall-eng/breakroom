...
export const CHAOS_POPUPS: ChaosPopupVariant[] = [
  ...
  },
  {
    ...
    body: 'FREE HOODIES',
    sub: '(none claimed)',
    imageKey: 'adFreeHoodies',
    mood: 'lowfi',
    cta: 'Claim Yours',
  },
  {
    id: 'broadbrain-subscribe',
    kind: 'statement',
    title: 'broadbrain.exe — partner offer',
    body: 'BROADBRAIN PRO',
    sub: 'Now thinking on your behalf. Cancel anytime. We keep the thoughts.',
    imageKey: 'adBroadbrain',
    mood: 'lowfi',
    cta: 'Subscribe',
  },
  {
    id: 'very-good-burger-coupon',
    kind: 'statement',
    title: 'verygoodburger.va — coupon',
    body: 'TWO FOR ONE',
    sub: "Bring this coupon. Don't bring a friend. Friend is not included.",
    imageKey: 'adVeryGoodBurger',
    mood: 'cardboard',
    cta: 'Print Coupon',
  },
